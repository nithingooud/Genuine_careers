            ...
            <Card className="max-w-5xl mx-auto mb-4 mt-4 shadow-md bg-white rounded-lg overflow-hidden">
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-4 px-2 mx-auto max-w-screen-xl text-center">
                        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">We are building a community</h1>
                        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Here at Genuine Careers we focus on helping students not only by providing job updates but also teaching and giving guidance.</p>
                        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                            <a href="https://t.me/genuinecareersbynithin" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                                Join Telegram
