    ...
    return (
        <div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 p-8" >
                <div className=" flex flex-col justify-between max-w-sm p-3 m-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-[320px] max-w-[320px] shadow-xl hover:shadow-2xl hover:scale-105 transition-all cursor-pointer hover:shadow-purple-400 bg-opacity-25 backdrop-filter backdrop-blur-md   ">
                ...
                <div className="max-w-sm p-3 m-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-[320px] max-w-[320px] shadow-xl hover:shadow-2xl hover:scale-105 transition-all cursor-pointer hover:shadow-purple-400 bg-opacity-25 backdrop-filter backdrop-blur-md   flex flex-col justify-between ">
                    <div className="flex flex-col items-center">
                        <div className="flex-grow flex items-start justify-center ">
                            <img
                                loading="lazy"
